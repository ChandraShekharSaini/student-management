...
redis_client = redis.Redis(
    host='python-cache-1k4hfo.serverless.use1.cache.amazonaws.com',
    port=6379,
    ssl=True,
...
db_write_config = {
    'host': 'database-1.ccvk6e62iz8h.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'Cloud123',
    'database': 'dev'
}
...
db_read_config = {
    'host': 'reader-ikoim.ccvk6e62iz8h.us-east-1.rds.amazonaws.com',
    'user': 'admin',
    'password': 'Cloud123',
    'database': 'dev'
}
